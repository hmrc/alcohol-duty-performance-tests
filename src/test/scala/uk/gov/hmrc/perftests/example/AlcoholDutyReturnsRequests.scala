...
object AlcoholDutyReturnsRequests extends ServicesConfiguration {
  ...
  def postSingleSprRateBeerPage: HttpRequestBuilder =
    http("Post Single Small Producer Relief Rate Beer Page")
      ...
      .formParam("volumesWithRate[0].pureAlcohol", "99.4500")
      ...
      .formParam("volumesWithRate[1].pureAlcohol", "78.9000")
      ...
      .formParam("volumesWithRate[2].pureAlcohol", "99.9900")
      ...
      .formParam("volumesWithRate[3].pureAlcohol", "66.5400")
